...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BUILD_GNU_TYPE': 'aarch64-apple-darwin25.2.0',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-I/opt/homebrew/include -flto=thin -std=c11 '
 ...
 'CONFIGURE_LDFLAGS_NODIST': '-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib '
                             '-flto=thin -Wl,-export_dynamic '
                             '-Wl,-object_path_lto,"$@".lto -g',
 'CONFIGURE_LDFLAGS_NOLTO': '-flto=thin',
 'CONFIG_ARGS': "'--prefix=/opt/homebrew/opt/python@3.12' "
                "'--enable-ipv6' "
                "'--datarootdir=/opt/homebrew/opt/python@3.12/share' "
                "'--datadir=/opt/homebrew/opt/python@3.12/share' "
                ...
                "'--with-lto' "
                "'--enable-framework=/opt/homebrew/opt/python@3.12/Frameworks' "
                "'--with-dtrace' '--with-dbmliborder=ndbm' "
                "'MACOSX_DEPLOYMENT_TARGET=26' "
                "'CFLAGS_NODIST=-I/opt/homebrew/include' "
                ...
                "'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/26' "
                "'CC=clang'",
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13/lcov-report',
 ...
 'DESTDIRS': '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12 '
             '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12/lib '
             '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12 '
             '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12/lib/python3.12/lib-dynload',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'aarch64-apple-darwin25.2.0',
 'INCLDIRSTOMAKE': '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12/include '
                   '/opt/homebrew/opt/python@3.12/Frameworks/Python.framework/Versions/3.12/include '
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                    ...
                    '-I/opt/homebrew/include -flto=thin -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden '
                    '-fprofile-instr-use=/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13/code.profclangd '
 ...
 'MODULE__LZMA_CFLAGS': '-I/opt/homebrew/Cellar/xz/5.8.2/include',
 'MODULE__LZMA_LDFLAGS': '-L/opt/homebrew/Cellar/xz/5.8.2/lib -llzma',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare '
                             ...
                             '-g -O3 -Wall -I/opt/homebrew/include -flto=thin '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
              '-fno-common -dynamic -DNDEBUG -g -O3 -Wall',
 'PY_CFLAGS_NODIST': '-I/opt/homebrew/include -flto=thin -std=c11 -Wextra '
                     '-Wno-unused-parameter -Wno-missing-field-initializers '
                     '-Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden '
 ...
 'PY_CORE_LDFLAGS': '-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib '
                    '-flto=thin -Wl,-export_dynamic '
                    '-Wl,-object_path_lto,"$@".lto -g',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare '
                        ...
                        '-O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 '
                        '-Wextra -Wno-unused-parameter '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13 '
               './python.exe -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13 '
 ...
 'abs_builddir': '/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13',
 'abs_srcdir': '/private/tmp/pythonA3.12-20260303-7845-1p4pqs/Python-3.12.13',
 'datarootdir': '/opt/homebrew/opt/python@3.12/share',
